import 'package:M_hassan_Portfolio/apiprovider.dart';
import 'package:M_hassan_Portfolio/responsive_widget.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            //   elevation: 0.0,
            //   onPressed: () =>
            //       html.window.open(Constants.PROFILE_MEDIUM, 'hasan'),
            // )
          ],
        ),
      ),
